...
async function main() {
  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Poulet Peri-Peri', desc: 'Poulet épicé à la portugaise, frites', price: 50000, prep: 25 },
      ],
    },
    {
      name: 'Plats Guinéens',
      ...
      items: [
        ...
        { name: 'Mafe', desc: 'Ragoût d\'arachide avec viande, riz', price: 40000, prep: 35 },
        { name: 'Fou Fou', desc: 'Pâte de manioc, sauce arachide ou gombo', price: 30000, prep: 30 },
        { name: 'Thiebou Dienne', desc: 'Riz rouge au poisson et légumes', price: 50000, prep: 40 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Pizza Calzone', desc: 'Pizza pliée, jambon, fromage, oeuf', price: 65000, prep: 25 },
        { name: 'Pizza KFM Speciale', desc: 'Tomate, mozzarella, poulet, poivrons, oignons', price: 75000, prep: 25 },
        { name: 'Pizza 4 Fromages', desc: 'Mozzarella, gorgonzola, chevre, parmesan', price: 70000, prep: 20 },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Beignet Glace', desc: 'Beignet garni de glace', price: 20000, prep: 8 },
        { name: 'Salade de Fruits', desc: 'Fruits de saison frais', price: 18000, prep: 5 },
        { name: 'Banane Flambee', desc: 'Banane caramélisée, glace vanille', price: 25000, prep: 10 },
      ],
    },
  ];
  ...
  const tables = [
    ...
    { number: 'VIP1', capacity: 6, isVip: true },
    { number: 'VIP2', capacity: 8, isVip: true },
  ];
