// Generate Menu Images for KFM DELICE
// This script generates realistic images for African dishes
...
const MENU_IMAGES = [
  // PLATS IVOIRIENS
  {
    ...
    prompt: 'Professional food photography of Attiéké Poisson Grillé, traditional Ivorian dish with grilled fish served on fermented cassava couscous with tomato sauce and fresh vegetables, on a rustic wooden plate, West African cuisine, appetizing, 4k food photography, studio lighting'
  },
  {
    category: 'plats-ivoiriens',
  ...
  },
  {
    category: 'plats-ivoiriens',
    filename: 'garba.jpg',
    prompt: 'Professional food photography of Garba, Ivorian street food with attiéké (cassava couscous), fried fish, onions and spicy pepper, served on a plate, West African cuisine, appetizing, 4k food photography'
  },
  {
    category: 'plats-ivoiriens',
  ...
  {
    category: 'plats-ivoiriens',
    filename: 'riz-gras-ivoirien.jpg',
    prompt: 'Professional food photography of Riz Gras Ivoirien, Ivorian jollof rice with tomato sauce, vegetables and meat, rich red color, West African cuisine, appetizing, 4k food photography'
  },
  ...
  },
  {
    ...
    prompt: 'Professional food photography of Poisson Braisé Guinéen, whole grilled fish with Guinean spices and seasonings, served with attiéké and vegetables, African cuisine, appetizing, 4k food photography'
  },
  ...
  {
    category: 'grillades',
    filename: 'poisson-grille-entier.jpg',
    prompt: 'Professional food photography of whole grilled fish, African style with charred skin and spicy seasoning, served on wooden platter with lime, appetizing, 4k food photography'
  },
  ...
  },
  {
    category: 'accompagnements',
    filename: 'frites.jpg',
    prompt: 'Professional food photography of French fries, golden crispy potato fries served in a basket with ketchup and mayo, appetizing, 4k food photography'
  },
  {
    category: 'accompagnements',
    filename: 'attieke.jpg',
    prompt: 'Professional food photography of Attiéké, West African fermented cassava couscous, white grainy texture served in a bowl, traditional side dish, appetizing, 4k food photography'
  },
  ...
  {
    category: 'boissons',
    filename: 'cafe-touba.jpg',
    prompt: 'Professional food photography of Café Touba, Senegalese spiced coffee in a small glass cup, dark rich coffee with spices, traditional African drink, appetizing, 4k food photography'
  },
  {
    category: 'boissons',
    filename: 'ataya.jpg',
  ...
  {
    category: 'desserts',
    filename: 'banane-caramel.jpg',
    prompt: 'Professional food photography of caramelized bananas, West African dessert with ripe bananas in rich caramel sauce, vanilla ice cream, appetizing, 4k food photography'
  },
];

async function generateImages() {
  console.log('🎨 Starting KFM DELICE Menu Image Generation...\n');
