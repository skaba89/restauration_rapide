...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 w-64 bg-sidebar border-r border-sidebar-border transform transition-transform duration-200 ease-in-out lg:translate-x-0 sidebar-glow',
