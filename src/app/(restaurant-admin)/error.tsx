...
export default function RestaurantAdminError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Restaurant admin error:', error);
  }, [error]);
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">Erreur Restaurant</h2>
        <p className="text-muted-foreground mb-6">
          Une erreur est survenue dans la gestion de votre restaurant.
          Veuillez réessayer.
        </p>
        ...
        <div className="flex gap-2 justify-center">
          <Button
            variant="outline"
            onClick={() => (window.location.href = '/my-restaurants')}
          >
