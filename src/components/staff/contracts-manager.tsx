...
const DEMO_CONTRACTS: Contract[] = [
  { id: '1', staffId: '1', staffName: 'Amadou Diallo', contractType: 'CDI', contractTypeLabel: 'CDI (Durée indéterminée)', contractNumber: 'CTR-2024-001', title: 'Contrat CDI - Directeur', startDate: new Date('2022-01-15'), endDate: null, trialPeriodDays: 90, salary: 5000000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 45, position: 'Directeur', department: 'Direction', benefits: JSON.stringify({ healthInsurance: true, transport: true, meals: true }), workingDays: null, noticePeriodDays: 30, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2022-01-10') },
  { id: '2', staffId: '2', staffName: 'Fatou Sylla', contractType: 'CDI', contractTypeLabel: 'CDI (Durée indéterminée)', contractNumber: 'CTR-2024-002', title: 'Contrat CDI - Chef Cuisinier', startDate: new Date('2022-03-01'), endDate: null, trialPeriodDays: 60, salary: 4000000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 48, position: 'Chef Cuisinier', department: 'Cuisine', benefits: JSON.stringify({ healthInsurance: true, meals: true }), workingDays: null, noticePeriodDays: 30, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2022-02-25') },
  { id: '3', staffId: '3', staffName: 'Ibrahim Keita', contractType: 'CDD', contractTypeLabel: 'CDD (Durée déterminée)', contractNumber: 'CTR-2024-003', title: 'Contrat CDD - Cuisinier (Saisonnier)', startDate: new Date('2023-01-10'), endDate: new Date('2024-12-31'), trialPeriodDays: 30, salary: 2500000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 45, position: 'Cuisinier', department: 'Cuisine', benefits: JSON.stringify({ meals: true }), workingDays: null, noticePeriodDays: 15, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2023-01-05') },
  { id: '4', staffId: '4', staffName: 'Marie Koulibaly', contractType: 'CDI', contractTypeLabel: 'CDI (Durée indéterminée)', contractNumber: 'CTR-2024-004', title: 'Contrat CDI - Serveuse', startDate: new Date('2023-06-15'), endDate: null, trialPeriodDays: 30, salary: 1500000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 40, position: 'Serveuse', department: 'Service', benefits: JSON.stringify({ meals: true, tips: true }), workingDays: null, noticePeriodDays: 15, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2023-06-10') },
  { id: '5', staffId: '5', staffName: 'Moussa Camara', contractType: 'CDD', contractTypeLabel: 'CDD (Durée déterminée)', contractNumber: 'CTR-2024-005', title: 'Contrat CDD - Livreur', startDate: new Date('2023-09-01'), endDate: new Date('2024-08-31'), trialPeriodDays: 14, salary: 1200000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 44, position: 'Livreur', department: 'Livraison', benefits: JSON.stringify({ transport: true, meals: true }), workingDays: null, noticePeriodDays: 7, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2023-08-28') },
  { id: '6', staffId: '6', staffName: 'Aissatou Traore', contractType: 'CDI', contractTypeLabel: 'CDI (Durée indéterminée)', contractNumber: 'CTR-2024-006', title: 'Contrat CDI - Caissière', startDate: new Date('2023-04-20'), endDate: null, trialPeriodDays: 30, salary: 1800000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 40, position: 'Caissière', department: 'Administration', benefits: JSON.stringify({ healthInsurance: true, meals: true }), workingDays: null, noticePeriodDays: 30, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2023-04-15') },
  { id: '7', staffId: '7', staffName: 'Sekou Konate', contractType: 'CDI', contractTypeLabel: 'CDI (Durée indéterminée)', contractNumber: 'CTR-2024-007', title: 'Contrat CDI - Cuisinier', startDate: new Date('2023-11-05'), endDate: null, trialPeriodDays: 30, salary: 2200000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 45, position: 'Cuisinier', department: 'Cuisine', benefits: JSON.stringify({ meals: true }), workingDays: null, noticePeriodDays: 15, clauses: null, documentUrl: null, status: 'terminated', terminationReason: 'Démission volontaire', terminationDate: new Date('2024-05-15'), createdAt: new Date('2023-11-01') },
  { id: '8', staffId: '8', staffName: 'Fanta Diarra', contractType: 'Trial', contractTypeLabel: 'Période d\'essai', contractNumber: 'CTR-2024-008', title: 'Période d\'essai - Serveuse', startDate: new Date('2024-01-15'), endDate: new Date('2024-02-14'), trialPeriodDays: 30, salary: 1500000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 40, position: 'Serveuse', department: 'Service', benefits: JSON.stringify({ meals: true }), workingDays: null, noticePeriodDays: 7, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2024-01-12') },
  { id: '9', staffId: '9', staffName: 'Oumar Bah', contractType: 'CDI', contractTypeLabel: 'CDI (Durée indéterminée)', contractNumber: 'CTR-2024-009', title: 'Contrat CDI - Agent d\'entretien', startDate: new Date('2024-02-01'), endDate: null, trialPeriodDays: 30, salary: 1000000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 35, position: 'Agent d\'entretien', department: 'Entretien', benefits: JSON.stringify({ meals: true }), workingDays: null, noticePeriodDays: 15, clauses: null, documentUrl: null, status: 'active', createdAt: new Date('2024-01-28') },
  { id: '10', staffId: '10', staffName: 'Adama Sow', contractType: 'CDD', contractTypeLabel: 'CDD (Durée déterminée)', contractNumber: 'CTR-2024-010', title: 'Contrat CDD - Livreur', startDate: new Date('2024-03-10'), endDate: new Date('2024-06-10'), trialPeriodDays: 7, salary: 1200000, salaryType: 'monthly', currency: 'GNF', workingHoursPerWeek: 44, position: 'Livreur', department: 'Livraison', benefits: JSON.stringify({ transport: true, meals: true }), workingDays: null, noticePeriodDays: 7, clauses: null, documentUrl: null, status: 'expired', createdAt: new Date('2024-03-08') },
];
